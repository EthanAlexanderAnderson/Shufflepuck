...
- (void)showInView:(UIView*)view
{
    ...
    // send callback
    _onShowCallback((__bridge void*)self, NPCreateError(nil));
}
...
- (void)dismiss
{
    ...
    // send callback
    _onHideCallback((__bridge void*)self, NPCreateError(nil));
}
...
- (void)runJavaScript:(NSString*)script withRequestTag:(void*)tagPtr
{
    [[self webView] evaluateJavaScript:script completionHandler:^(id _Nullable result, NSError* _Nullable error) {
        ...
        if (!error)
        {
            ...
            _runJavaScriptCallback((__bridge void*)self, NPCreateCStringFromNSString(resultJSONStr), NPCreateError(nil), tagPtr);
        }
        else
        {
            _runJavaScriptCallback((__bridge void*)self, nil, NPCreateError([NPWebViewError createFrom:error]), tagPtr);
        }
    }];
}
...
- (void)webView:(WKWebView*)webView didStartProvisionalNavigation:(null_unspecified WKNavigation*)navigation
{
    ...
    // send callback
    _loadStartCallback((__bridge void*)self, NPCreateError(nil));
}
...
- (void)webView:(WKWebView*)webView didFinishNavigation:(null_unspecified WKNavigation*)navigation
{
    ...
    // send callback
    _loadFinishCallback((__bridge void*)self, NPCreateError(nil));
}
...
- (void)webView:(WKWebView*)webView didFailNavigation:(null_unspecified WKNavigation*)navigation withError:(NSError*)error
{
    ...
    // send callback
    _loadFinishCallback((__bridge void*)self, NPCreateError([NPWebViewError createFrom: error]));
}
