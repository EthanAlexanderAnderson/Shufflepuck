...
// internal properties
@property(nonatomic, strong) SLComposeViewController*           internalComposer;
@property(nonatomic) SLComposeViewControllerCompletionHandler   completionHandler;
@property(nonatomic) UINavigationController *viewControllerToPresent;
...
- (id)initWithServiceType:(NSString*)serviceType
{
    ...
    if (self)
    {
        ...
        self.internalComposer    = [SLComposeViewController composeViewControllerForServiceType:serviceType];
        [self.internalComposer setCompletionHandler:^(SLComposeViewControllerResult result) {
