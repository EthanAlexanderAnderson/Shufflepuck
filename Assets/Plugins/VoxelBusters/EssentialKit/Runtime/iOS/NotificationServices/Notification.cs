...
#region Fields
        ...
        private     bool                            m_isLaunchNotification;
...
#region Constructors
            ...
            : base(notificationId)
        {
            ...
            m_isLaunchNotification = false;
        }


        public Notification(IntPtr requestPtr, bool isLaunchNotification = false)
            : base(NotificationBinding.NPNotificationRequestGetId(requestPtr))
        {
            ...
            m_isLaunchNotification = isLaunchNotification;
        }
