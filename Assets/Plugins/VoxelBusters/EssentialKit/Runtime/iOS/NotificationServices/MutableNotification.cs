...
namespace VoxelBusters.EssentialKit.NotificationServicesCore.iOS
{
    internal sealed class MutableNotification : Notification, IMutableNotification
    {
        ...
        {
            NotificationBinding.NPNotificationContentSetPriority(GetNativeContentInternal().Pointer, value);
        }
        ...
        private IntPtr CreateNativeTrigger(INotificationTrigger trigger)
        {
            ...
            else if (trigger is CalendarNotificationTrigger)
            {
                ...
                return NotificationBinding.NPCalendarNotificationTriggerCreate(calendarTrigger.DateComponents, calendarTrigger.Repeats);
            }
