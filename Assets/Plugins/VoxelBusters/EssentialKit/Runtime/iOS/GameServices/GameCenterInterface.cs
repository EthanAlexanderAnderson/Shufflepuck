...
namespace VoxelBusters.EssentialKit.GameServicesCore.iOS
{
    public sealed class GameCenterInterface : NativeGameServicesInterfaceBase 
    {
        ...
        {
            var     leaderboardIds  = Array.ConvertAll(leaderboardDefinitions, (item) => item.GetPlatformIdForActivePlatform());
            Leaderboard.LoadLeaderboards(leaderboardIds, callback);
        }
