    ...
    internal static class AddressBookUtility
    {
        ...
        public static AddressBookContactsAccessStatus ConvertToAddressBookContactsAccessStatus(CNAuthorizationStatus status)
        {
            switch (status)
            {
                ...
                case CNAuthorizationStatus.CNAuthorizationStatusLimited:
                    return AddressBookContactsAccessStatus.Limited;
        ...
        public static NativeReadContactsOptionsData From(ReadContactsOptions options)
        {
            var nativeOptions = new NativeReadContactsOptionsData();
            nativeOptions.Limit         = options.Limit;
            nativeOptions.Offset        = options.Offset;
            nativeOptions.Constraints   = options.Constraints;
