...
namespace VoxelBusters.EssentialKit.AddressBookCore.Simulator
{
    internal sealed class AddressBookContact : AddressBookContactBase, IAddressBookContact
    {
        ...
        public AddressBookContact(string firstName, string middleName = "", string lastName = "", string[] phoneNumbers = null, string[] emailAddresses = null, string companyName = null)
        {
            // set properties
        ...
        protected override string GetCompanyNameInternal()
        {
