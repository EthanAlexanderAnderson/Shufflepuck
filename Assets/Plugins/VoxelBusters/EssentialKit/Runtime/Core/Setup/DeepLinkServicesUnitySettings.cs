...
{
    [Serializable]
    public partial class DeepLinkServicesUnitySettings : SettingsPropertyGroup 
    {
        #region Fields
        ...
        public DeepLinkServicesUnitySettings(bool isEnabled = true, IosPlatformProperties iosProperties = null,
            AndroidPlatformProperties androidProperties = null) 
            : base(isEnabled: isEnabled, name: NativeFeatureType.kDeepLinkServices)
        { 
            // set properties
