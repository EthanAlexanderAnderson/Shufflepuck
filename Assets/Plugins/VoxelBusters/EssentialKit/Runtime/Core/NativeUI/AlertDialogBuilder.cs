...
namespace VoxelBusters.EssentialKit
{
    ...
    public class AlertDialogBuilder
    {
        ...
        /// </summary>
        /// <param name="options">[Optional] The options for the text input field built with <see cref="TextInputFieldOptions.Builder"/>. </param>
        public AlertDialogBuilder AddTextInputField(TextInputFieldOptions options = null)
        {
            m_alertDialog.AddTextInputField(options);
            return this;
        }
        ...
        /// </summary>
        /// <param name="title">The title of the button.</param>
        /// <param name="callback<string[]>">The method to execute when the user selects this button which returns the input field values, if any.</param>
