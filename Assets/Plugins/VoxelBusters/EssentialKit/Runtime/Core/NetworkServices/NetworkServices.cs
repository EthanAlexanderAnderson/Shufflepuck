...
namespace VoxelBusters.EssentialKit
{
    ...
    *   @brief Provides cross-platform interface to check network connectivity status.
    */
    ...
    public static class NetworkServices
    {
        ...
        public static void Initialize(NetworkServicesUnitySettings settings)
        {
            ...
            // Configure interface
            s_nativeInterface       = NativeFeatureActivator.CreateInterface<INativeNetworkServicesInterface>(ImplementationSchema.NetworkServices, true);
