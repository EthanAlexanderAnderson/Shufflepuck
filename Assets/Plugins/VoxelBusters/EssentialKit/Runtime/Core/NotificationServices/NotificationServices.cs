...
{
    /** @defgroup NotificationServices Notification Services
     *  @brief Provides cross-platform interface for scheduling, registering and handling notifications.
     */
    ...
    public static class NotificationServices
    {
        ...
        internal static INativeNotificationCenterInterface NativeInterface => s_nativeInterface;
        ...
        public static void Initialize(NotificationServicesUnitySettings settings)
        {
            ...
            OnRegisterForPushNotificationsComplete  = null;
            ...
            // Configure interface
            s_nativeInterface       = NativeFeatureActivator.CreateInterface<INativeNotificationCenterInterface>(ImplementationSchema.NotificationServices, true);
        ...
        public static void ScheduleNotification(INotification notification, CompletionCallback callback = null)
        {
            ...
            {
                DebugLogger.LogError(EssentialKitDomain.Default, "Notification object is null.");
                return;
            }
            ...
            {
                // make request
                s_nativeInterface.ScheduleNotification(notification, (success, error) =>
                {
        ...
        public static void GetScheduledNotifications(EventCallback<NotificationServicesGetScheduledNotificationsResult> callback = null)
        {
            try
            {
                ...
                s_nativeInterface.GetScheduledNotifications((notifications, error) =>
                {
                    ...
                    // send result to caller object
                    var     result          = new NotificationServicesGetScheduledNotificationsResult(notifications);
        ...
        { 
            ...
            {
                DebugLogger.LogError(EssentialKitDomain.Default, "Notification id is null/empty.");
                return;
            }
        ...
        public static void GetDeliveredNotifications(EventCallback<NotificationServicesGetDeliveredNotificationsResult> callback = null)
        {
            try
            {
                ...
                s_nativeInterface.GetDeliveredNotifications((notifications, error) =>
                {
                    ...
                    // send result to caller object
                    var     result      = new NotificationServicesGetDeliveredNotificationsResult(notifications);
                    CallbackDispatcher.InvokeOnMainThread(callback, result, error);
                });
            }
            catch (Exception exception)
        ...
        public static void RegisterForPushNotifications(EventCallback<NotificationServicesRegisterForPushNotificationsResult> callback = null)
        {
            try
            {
                ...
                s_nativeInterface.RegisterForPushNotifications((deviceToken, error) =>
                {
                    ...
                    // notify listeners
                    var     result      = new NotificationServicesRegisterForPushNotificationsResult(deviceToken);
                    CallbackDispatcher.InvokeOnMainThread(callback, result, error);
        ...
        {
            // send result to caller object
            var     result          = new NotificationServicesRequestPermissionResult(permissionStatus);
            CallbackDispatcher.InvokeOnMainThread(callback, result, error);
        }
            ...
            try
            {
                ...
                s_nativeInterface.GetSettings((settings) =>
                {
                    ...
                    var     newSettings     = new NotificationSettings(
                        ...
                        exactTimingSetting: settings.ExactTimingSetting);
                    CachedSettings          = newSettings;

                    // notify listeners
                    var     result          = new NotificationServicesGetSettingsResult(newSettings);
        ...
        private static void CopyPushNotificationPropertiesToCachedSettings(bool sendUpdateEvent = true)
        {
            ...
            var     newSettingsCopy     = new NotificationSettings(
                ...
                pushNotificationEnabled: (s_deviceToken != null), 
                deviceToken: s_deviceToken, 
                exactTimingSetting: CachedSettings.ExactTimingSetting);
        ...
        {
            // send result to caller object
            var     result      = new NotificationServicesNotificationReceivedResult(notification);
