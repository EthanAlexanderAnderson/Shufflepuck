...
namespace VoxelBusters.EssentialKit
{
    ...
    public class NotificationBuilder
    {
        ...
        public NotificationBuilder SetSubtitle(string value)
        {
            ...
            if (null == value)
            {
                DebugLogger.LogWarning(EssentialKitDomain.Default, "Subtitle value is null.");
                return this;
            }
        ...
        public NotificationBuilder SetBody(string value)
        {
            ...
            if (null == value)
            {
                DebugLogger.LogWarning(EssentialKitDomain.Default, "Body value is null.");
                return this;
            }
        ...
        public NotificationBuilder SetBadge(int value)
        {
            ...
            if (value < 0)
            {
                DebugLogger.LogWarning(EssentialKitDomain.Default, "Badge value must be a positive number.");
                return this;
            }
        ...
        public NotificationBuilder SetUserInfo(Dictionary<string, string> value)
        {
            ...
            if (null == value)
            {
                DebugLogger.LogWarning(EssentialKitDomain.Default, "User info value is null.");
                return this;
            }
        ...
        /// Sets the custom userinfo property of notification.
        /// </summary>
        /// <param name="values">Key value pair values.</param>
        ...
        public NotificationBuilder SetSoundFileName(string value)
        {
            ...
            if (null == value)
            {
                DebugLogger.LogWarning(EssentialKitDomain.Default, "Sound file name value is null.");
                return this;
            }
        ...
        public NotificationBuilder SetIosProperties(NotificationIosProperties value)
        {
            ...
            if (null == value)
            {
                DebugLogger.LogWarning(EssentialKitDomain.Default, "iOS properties value is null.");
                return this;
            }
        ...
        public NotificationBuilder SetAndroidProperties(NotificationAndroidProperties value)
        {
            ...
            if (null == value)
            {
                DebugLogger.LogWarning(EssentialKitDomain.Default, "Android properties value is null.");
                return this;
            }
        ...
        public NotificationBuilder SetTimeIntervalNotificationTrigger(double interval, bool repeats = false)
        {
            ...
            if (interval <= 0)
            {
                DebugLogger.LogWarning(EssentialKitDomain.Default, "Interval value must be a positive number.");
                return this;
            }
        ...
        public NotificationBuilder SetCalendarNotificationTrigger(DateComponents dateComponent, bool repeats = false)
        {
            ...
            {
                DebugLogger.LogWarning(EssentialKitDomain.Default, "Date component value is null.");
                return this;
            }
        ...
        /// </summary>
        /// <param name="priority"> Value representing the priority of the notification.</param>
        /// <returns></returns>

        public NotificationBuilder SetPriority(NotificationPriority priority)
        {
            // set value
            m_notification.SetPriority(priority);
