...
namespace VoxelBusters.EssentialKit
{
    ...
    public class NotificationSettings
    {
        ...
        internal NotificationSettings(NotificationPermissionStatus permissionStatus, NotificationSettingStatus alertSetting,
            ...
            NotificationPreviewStyle previewStyle, bool pushNotificationEnabled, string deviceToken, NotificationSettingStatus exactTimingSetting)
        {
            // set properties
            ...
            ExactTimingSetting          = exactTimingSetting;
        }
