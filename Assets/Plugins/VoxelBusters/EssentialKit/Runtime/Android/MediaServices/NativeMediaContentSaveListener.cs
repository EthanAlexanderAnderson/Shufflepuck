...
{
    public class NativeMediaContentSaveListener : AndroidJavaProxy
    {
        #region Delegates
        ...
        public NativeMediaContentSaveListener() : base("com.voxelbusters.essentialkit.mediaservices.IMediaServices$IMediaContentSaveListener")
        {
        }
