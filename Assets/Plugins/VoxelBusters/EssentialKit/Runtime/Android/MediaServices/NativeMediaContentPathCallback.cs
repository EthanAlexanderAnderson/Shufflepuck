...
{
    public class NativeMediaContentPathCallback : AndroidJavaProxy
    {
        #region Delegates

        public delegate void OnFailureDelegate(NativeErrorInfo error);
        public delegate void OnSuccessDelegate(string path);
        ...
        public NativeMediaContentPathCallback() : base("com.voxelbusters.essentialkit.mediaservices.IMediaServices$IMediaContentPathCallback")
        {
        }
        ...
        {
#if NATIVE_PLUGINS_DEBUG_ENABLED
            DebugLogger.Log("[Proxy : Callback] : " + "onSuccess"  + " " + "[" + "path" + " : " + path +"]");
#endif
