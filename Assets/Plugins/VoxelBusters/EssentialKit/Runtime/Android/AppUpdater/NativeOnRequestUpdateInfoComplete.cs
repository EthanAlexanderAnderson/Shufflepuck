...
{
    public class NativeOnRequestUpdateInfoComplete : AndroidJavaProxy
    {
        #region Delegates

        public delegate void OnFailureDelegate(NativeErrorInfo errorInfo);
        public delegate void OnSuccessDelegate(NativeUpdateInfo info);
        ...
        public NativeOnRequestUpdateInfoComplete() : base("com.voxelbusters.essentialkit.appupdater.IOnRequestUpdateInfoComplete")
        {
        }
        ...
        public void onSuccess(AndroidJavaObject info)
        {
            ...
            {
                onSuccessCallback(new NativeUpdateInfo(info));
            }
        }
