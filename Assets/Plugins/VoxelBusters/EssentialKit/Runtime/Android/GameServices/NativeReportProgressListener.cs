...
{
    public class NativeReportProgressListener : AndroidJavaProxy
    {
        #region Delegates
        ...
        public NativeReportProgressListener() : base("com.voxelbusters.essentialkit.gameservices.IGameServices$IReportProgressListener")
        {
        }
