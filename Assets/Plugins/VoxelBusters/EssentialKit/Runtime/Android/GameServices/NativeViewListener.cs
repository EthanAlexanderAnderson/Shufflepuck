...
namespace VoxelBusters.EssentialKit.GameServicesCore.Android
{
    public class NativeViewListener : AndroidJavaProxy
    {
        ...
        public delegate void OnCloseDelegate(NativeErrorInfo error);
        ...
        public NativeViewListener() : base("com.voxelbusters.essentialkit.gameservices.IGameServices$IViewListener")
        {
        }
        ...
        public void onClose(AndroidJavaObject error)
        {
#if NATIVE_PLUGINS_DEBUG_ENABLED
            ...
            {
                onCloseCallback(new NativeErrorInfo(error));
            }
        }
