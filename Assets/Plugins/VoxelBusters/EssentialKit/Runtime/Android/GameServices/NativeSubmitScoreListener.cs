...
{
    public class NativeSubmitScoreListener : AndroidJavaProxy
    {
        #region Delegates
        ...
        public NativeSubmitScoreListener() : base("com.voxelbusters.essentialkit.gameservices.IGameServices$ISubmitScoreListener")
        {
        }
