...
{
    public class NativeRequestStoreReviewListener : AndroidJavaProxy
    {
        #region Delegates
        ...
        public NativeRequestStoreReviewListener() : base("com.voxelbusters.essentialkit.ratemyapp.IStoreReview$IRequestStoreReviewListener")
        {
        }
