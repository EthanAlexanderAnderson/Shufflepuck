...
{
    public class NativeAppShortcutClickListener : AndroidJavaProxy
    {
        #region Delegates

        public delegate void OnClickDelegate(string identifier);
        ...
        public NativeAppShortcutClickListener() : base("com.voxelbusters.essentialkit.appshortcuts.IAppShortcutClickListener")
        {
        }
        ...
        {
#if NATIVE_PLUGINS_DEBUG_ENABLED
            DebugLogger.Log("[Proxy : Callback] : " + "onClick"  + " " + "[" + "identifier" + " : " + identifier +"]");
#endif
