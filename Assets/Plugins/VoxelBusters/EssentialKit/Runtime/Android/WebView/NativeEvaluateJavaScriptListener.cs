...
{
    public class NativeEvaluateJavaScriptListener : AndroidJavaProxy
    {
        #region Delegates

        public delegate void OnFailureDelegate(NativeErrorInfo error);
        public delegate void OnSuccessDelegate(string result);
        ...
        public NativeEvaluateJavaScriptListener() : base("com.voxelbusters.essentialkit.webview.IEvaluateJavaScriptListener")
        {
        }
        ...
        {
#if NATIVE_PLUGINS_DEBUG_ENABLED
            DebugLogger.Log("[Proxy : Callback] : " + "onSuccess"  + " " + "[" + "result" + " : " + result +"]");
#endif
