...
{
    public class NativeCopyAssetListener : AndroidJavaProxy
    {
        #region Delegates
        ...
        public NativeCopyAssetListener() : base("com.voxelbusters.essentialkit.utilities.common.interfaces.ICopyAssetListener")
        {
        }
