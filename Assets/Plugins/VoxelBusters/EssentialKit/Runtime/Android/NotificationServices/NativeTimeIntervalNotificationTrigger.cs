...
namespace VoxelBusters.EssentialKit.NotificationServicesCore.Android
{
    public class NativeTimeIntervalNotificationTrigger : NativeAndroidJavaObjectWrapper
    {
        ...
        public NativeTimeIntervalNotificationTrigger(long timeInterval, bool repeat) : base(Native.kClassName ,(object)timeInterval, (object)repeat)
        {
        }
        ...
        {
            internal const string kClassName = "com.voxelbusters.essentialkit.notificationservices.datatypes.TimeIntervalNotificationTrigger";
