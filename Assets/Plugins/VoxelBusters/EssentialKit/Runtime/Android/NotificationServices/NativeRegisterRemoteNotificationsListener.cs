...
namespace VoxelBusters.EssentialKit.NotificationServicesCore.Android
{
    public class NativeRegisterRemoteNotificationsListener : AndroidJavaProxy
    {
        ...
        public NativeRegisterRemoteNotificationsListener() : base("com.voxelbusters.essentialkit.notificationservices.INotificationServices$IRegisterRemoteNotificationsListener")
        {
        }
