...
namespace VoxelBusters.EssentialKit.NotificationServicesCore.Android
{
    public class NativeLocationNotificationTrigger : NativeAndroidJavaObjectWrapper
    {
        ...
        public NativeLocationNotificationTrigger(double latitude, double longitude, float radius, bool repeat) : base(Native.kClassName ,(object)latitude, (object)longitude, (object)radius, (object)repeat)
        {
        }
