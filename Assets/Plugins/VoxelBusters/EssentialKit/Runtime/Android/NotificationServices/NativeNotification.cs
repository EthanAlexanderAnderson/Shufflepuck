...
namespace VoxelBusters.EssentialKit.NotificationServicesCore.Android
{
    public class NativeNotification : NativeAndroidJavaObjectWrapper
    {
        ...
        public NativeNotificationPriority Priority
        {
            get
            {
                return NativeNotificationPriorityHelper.ReadFromValue(Get<AndroidJavaObject>("priority"));
            }

            set
            {
                Set<AndroidJavaObject>("priority", NativeNotificationPriorityHelper.CreateWithValue(value));
            }
        }
        ...
        public int PersistenceId
        {
            get
            {
                return Get<int>("persistenceId");
            }

            set
            {
                Set<int>("persistenceId", value);
            }
        }
        ...
        public bool Process
        {
            get
            {
                return Get<bool>("process");
            }

            set
            {
                Set<bool>("process", value);
            }
        }
        ...
        public NativeNotification(string notificationId) : base(Native.kClassName ,(object)notificationId)
        {
        }
        ...
        public bool HasCalendarTimeTrigger()
        {
            return Call<bool>(Native.Method.kHasCalendarTimeTrigger);
        }
        ...
        {
            internal const string kClassName = "com.voxelbusters.essentialkit.notificationservices.datatypes.Notification";

            internal class Method
            {
                internal const string kFromJson = "fromJson";
                internal const string kHasCalendarTimeTrigger = "hasCalendarTimeTrigger";
