...
{
    public class NativeScheduleNotificationListener : AndroidJavaProxy
    {
        #region Delegates
        ...
        public NativeScheduleNotificationListener() : base("com.voxelbusters.essentialkit.notificationservices.INotificationServices$IScheduleNotificationListener")
        {
        }
