        ...
        protected override void OnActionSelectInternal(AlertDialogDemoAction selectedAction)
        {
            switch (selectedAction.ActionType)
            {
               case AlertDialogDemoActionType.New:
                ...
                case AlertDialogDemoActionType.AddTextInputField:
                    TextInputFieldOptions options = new TextInputFieldOptions.Builder().SetPlaceholderText("Enter email address here...").SetKeyboardInputType(KeyboardInputType.EmailAddress).Build();
                    m_activeDialog.AddTextInputField(options);
                    break;
