...
namespace VoxelBusters.EssentialKit.Demo
{
	public class ShareSheetDemo : DemoActionPanelBase<ShareSheetDemoAction, ShareSheetDemoActionType>
	{
        ...
        /*
        private IEnumerator ShareMovie(string fileNameWithExtension)
        {
             var url = System.IO.Path.Combine(Application.streamingAssetsPath, fileNameWithExtension);
            ...
            shareSheet.AddAttachment(data, "video/mp4", "video.mp4");
            shareSheet.Show();
        }*/
