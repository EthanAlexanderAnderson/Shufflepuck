...
namespace VoxelBusters.EssentialKit.Editor
{
    public class UpgradeUtility
    {
        ...
        public static EssentialKitSettings ImportSettings()
        {
            ...
            {
                DebugLogger.LogError(EssentialKitDomain.Default, "Failed to locate json file.");
                return null;
            }
        ...
        private static ApplicationSettings ImportApplicationSettingsFromJson(IDictionary jsonDict)
        {
            ...
            return new ApplicationSettings(
                appStoreIds: new RuntimePlatformConstantSet(ios: iosId, tvos: iosId, android: androidId));
        }
        ...
        private static BillingServicesUnitySettings ImportBillingSettingsFromJson(IDictionary jsonDict)
        {
            ...
            foreach (IDictionary metaDict in productJsonMetaArray)
            {
                ...
                var     iOSProductId        = RuntimePlatformConstantUtility.GetConstantValueForPlatform(platformValues, RuntimePlatform.IPhonePlayer);
                var     androidProductId    = RuntimePlatformConstantUtility.GetConstantValueForPlatform(platformValues, RuntimePlatform.Android);
                ...
                productDefinitionList.Add(new BillingProductDefinition(
                    id: title, 
                    platformIdOverrides: new RuntimePlatformConstantSet(ios: iOSProductId, tvos: iOSProductId, android: androidProductId),
        ...
        private static CloudServicesUnitySettings ImportCloudSettingsFromJson(IDictionary jsonDict)
        {
            ...
            // create object
            return new CloudServicesUnitySettings(isEnabled: isEnabled);
        }
        ...
        private static GameServicesUnitySettings ImportGameServicesSettingsFromJson(IDictionary jsonDict)
        {
            ...
            foreach (IDictionary metaDict in leaderboardMetaJsonArray)
            {
                ...
                var     iOSLeaderboardId        = RuntimePlatformConstantUtility.GetConstantValueForPlatform(platformIds, RuntimePlatform.IPhonePlayer);
                var     androidLeaderboardId    = RuntimePlatformConstantUtility.GetConstantValueForPlatform(platformIds, RuntimePlatform.Android);
                leaderboardList.Add(new LeaderboardDefinition(
                    id: id, 
                    platformIdOverrides: new RuntimePlatformConstantSet(ios: iOSLeaderboardId, tvos: iOSLeaderboardId, android: androidLeaderboardId),
                    title: id));
            }
            ...
            foreach (IDictionary metaDict in achievementMetaJsonArray)
            {
                ...
                var     platformIds             = ConvertToPlatformConstants(platformIdJsonArray);
                var     iOSAchievementId        = RuntimePlatformConstantUtility.GetConstantValueForPlatform(platformIds, RuntimePlatform.IPhonePlayer);
                var     androidAchievementId    = RuntimePlatformConstantUtility.GetConstantValueForPlatform(platformIds, RuntimePlatform.Android);
                achievementList.Add(new AchievementDefinition(
                    id: id, 
                    platformIdOverrides: new RuntimePlatformConstantSet(ios: iOSAchievementId, tvos: iOSAchievementId, android: androidAchievementId),
                    title: id, 
        ...
        private static NotificationServicesUnitySettings ImportNotificationServicesSettingsFromJson(IDictionary jsonDict)
        {
            ...
            // create object
            var     pushServiceType     = usesPushService ? PushNotificationServiceType.Custom : PushNotificationServiceType.None;
        ...
        private static RateMyAppUnitySettings ImportRateMyAppSettingsFromJson(IDictionary jsonDict)
        {
            // read properties
            ...
            var     defaultValidatorSettings        = new RateMyAppConstraints(new RateMyAppConstraints.PromptConstraints(showFirstPromptAfterHours, 0), new RateMyAppConstraints.PromptConstraints(successivePromptAfterHours, successivePromptAfterLaunches));
            return new RateMyAppUnitySettings(isEnabled, dialogSettings, defaultValidatorSettings);
        }
        ...
        private static RuntimePlatformConstant[] ConvertToPlatformConstants(IList jsonArray)
        {
            var     constantList    = new List<RuntimePlatformConstant>();
            foreach (IDictionary idDict in jsonArray)
            {
                ...
                {
                    case 0:
                        constantList.Add(RuntimePlatformConstant.iOS(value));
                        break;

                    case 1:
                        constantList.Add(RuntimePlatformConstant.Android(value));
                        break;
                }
            }
